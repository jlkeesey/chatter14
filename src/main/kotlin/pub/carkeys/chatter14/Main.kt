...
/**
 * Reads the arguments for a logging level setting value and if present uses that to set
 * the current logging level of the system. If the parameter is present it is removed from
 * the command line before passing it on to the Application. This needs to be handled here
