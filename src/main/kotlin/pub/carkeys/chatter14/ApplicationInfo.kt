 ...
 *
 * @property name the name of this application. This is generally the application command line
 *     name.
...
data class ApplicationInfo(val name: String, val title: String, val version: String) {
    companion object {
        ...
        /**
         * Loads the application information from the generated resource property file of the build.
