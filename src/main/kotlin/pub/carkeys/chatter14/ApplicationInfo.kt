...
/**
 * Contains the basic application information as generated by the build proces such as
 * application name and version.
 *
 * @property name the name of this application. This is generally the applicaton command line
 *     name.
 * @property title the application title. This is generally used as the title on the main
 *     panel of the application.
 * @property version the application version. This is the current version of the application
 *     as it is known to the build system
 */
data class ApplicationInfo(val name: String, val title: String, val version: String) {
    companion object {
        ...
        /**
         * Loads the application information from the gerneated resouce property file of the build.
         * This can be invoked from a static environment.
         *
