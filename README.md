...
![Stable](https://img.shields.io/badge/Stable-0.9.0-blue?style=for-the-badge "Stable version 0.9.0")
...
- [Acknowledgements and Licenses](#installation-acknowledgement)
...
the output file. Many "conversations" in **Final Fantasy 14** are carried out in a
combination of chat and emotes.
...
| replaceIfExists | If true then any existing target TXT files will be replaced, otherwise no output file is written. Default is `false`.                                                 |
...
| server          | The name of your server. This must be one of the valid servers in the given data center existing at the time this application was built. Default to `Zalera`.         |
...
The participants is a list of all of the characters to include in the group. Each entry
...
Here is a sample configuration that demonstrates every option.
...
The Windows version is packaged as an installer, just run the installer and it should
...
## <a name="installation-acknowledgement">Acknowledgements and Licenses</a>
